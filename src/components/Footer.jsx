          ...
          <div>
            ...
            <div className="flex space-x-4 mt-4">
              <button
                ...
                className="text-cream hover:text-wheat transition-colors bg-transparent border-none cursor-pointer p-0"
                aria-label="Facebook"
              >
                <svg
                  className="w-6 h-6"
            ...
            <ul className="space-y-2">
              <li>
                <button
                  ...
                  className="text-cream/80 hover:text-wheat transition-colors bg-transparent border-none cursor-pointer p-0 text-left"
                >
                  Naslovnica
                </button>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <span className="text-cream/80">+385 99 757 3923</span>
              </li>
              <li className="flex items-center">
                <svg
                  className="w-5 h-5 mr-3 text-wheat"
